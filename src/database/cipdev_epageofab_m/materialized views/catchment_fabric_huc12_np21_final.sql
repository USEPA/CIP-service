DROP MATERIALIZED VIEW IF EXISTS cipdev_epageofab_m.catchment_fabric_huc12_np21_final CASCADE;

DROP SEQUENCE IF EXISTS cipdev_epageofab_m.catchment_fabric_huc12_np21_final_seq;
CREATE SEQUENCE cipdev_epageofab_m.catchment_fabric_huc12_np21_final_seq START WITH 1;

CREATE MATERIALIZED VIEW cipdev_epageofab_m.catchment_fabric_huc12_np21_final(
    objectid
   ,xwalk_huc12
   ,xwalk_huc12_version
   ,areasqkm
...
AS
SELECT
 NEXTVAL('cipdev_epageofab_m.catchment_fabric_huc12_np21_final_seq')::INTEGER AS objectid
,a.xwalk_huc12
...
ALTER TABLE cipdev_epageofab_m.catchment_fabric_huc12_np21_final OWNER TO cipsrv;
GRANT SELECT ON cipdev_epageofab_m.catchment_fabric_huc12_np21_final TO public;

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_huc12_np21_final_pk
ON cipdev_epageofab_m.catchment_fabric_huc12_np21_final(xwalk_huc12);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_huc12_np21_final_u01
ON cipdev_epageofab_m.catchment_fabric_huc12_np21_final(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_huc12_np21_final_u02
ON cipdev_epageofab_m.catchment_fabric_huc12_np21_final(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_huc12_np21_final_spx
ON cipdev_epageofab_m.catchment_fabric_huc12_np21_final USING gist(shape);

ANALYZE cipdev_epageofab_m.catchment_fabric_huc12_np21_final;

--VACUUM FREEZE ANALYZE cipdev_epageofab_m.catchment_fabric_huc12_np21_final;

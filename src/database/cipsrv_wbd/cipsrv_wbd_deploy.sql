...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_np21_5070 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_np21_3338 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_np21_26904 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_np21_32161 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_np21_32655 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_np21_32702 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu10sp_np21_3338 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu10sp_np21_26904 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu10sp_np21_32161 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu10sp_np21_32655 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu10sp_np21_5070 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_np21_3338 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_np21_26904 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_np21_32161 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_np21_32655 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_np21_32702 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_np21_5070 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_np21_5070 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_np21_3338 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_np21_26904 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_np21_32161 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_np21_32655 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_np21_32702 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu4sp_np21_5070 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu4sp_np21_3338 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu4sp_np21_26904 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu4sp_np21_32161 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      ,ggg.centermass_y
      ,ggg.globalid
      ,(SELECT ST_UNION(gggg.shape) FROM cipsrv_wbd.wbd_hu12_np21 gggg WHERE SUBSTR(gggg.huc12,1,6) = '220400') AS shape
      FROM
      cipsrv_wbd.wbd_hu12_np21 ggg
      WHERE
...
FROM (
   ...
   FROM (
      ...
      ,ggg.centermass_y
      ,ggg.globalid
      ,(SELECT ST_UNION(gggg.shape) FROM cipsrv_wbd.wbd_hu12sp_np21 gggg WHERE SUBSTR(gggg.huc12,1,4) = '2204') AS shape
      FROM
      cipsrv_wbd.wbd_hu12sp_np21 ggg
      WHERE
      SUBSTR(ggg.huc12,1,4) = '2204'
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_nphr_5070 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_nphr_3338 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_nphr_26904 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_nphr_32161 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_nphr_32655 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu12sp_nphr_32702 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu10sp_nphr_3338 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu10sp_nphr_26904 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu10sp_nphr_32161 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu10sp_nphr_32655 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu10sp_nphr_5070 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu10sp_nphr_32702 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_nphr_3338 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_nphr_26904 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_nphr_32161 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_nphr_32655 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_nphr_32702 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu8sp_nphr_5070 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_nphr_5070 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_nphr_3338 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_nphr_26904 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_nphr_32161 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_nphr_32655 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu6sp_nphr_32702 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu4sp_nphr_5070 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu4sp_nphr_3338 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu4sp_nphr_26904 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipsrv_wbd.wbd_hu4sp_nphr_32161 aaaa
      ) aaa
      CROSS JOIN
	   LATERAL UNNEST(aaa.states_array) AS u(val)
      GROUP BY
...
FROM (
   ...
   FROM (
      ...
      ,ggg.centermass_y
      ,ggg.globalid
      ,(SELECT ST_UNION(gggg.shape) FROM cipsrv_wbd.wbd_hu12_nphr gggg WHERE SUBSTR(gggg.huc12,1,6) = '220400') AS shape
      FROM
      cipsrv_wbd.wbd_hu12_nphr ggg
      WHERE
      SUBSTR(ggg.huc12,1,6) = '220400'
...
FROM (
   ...
   FROM (
      ...
      ,ggg.centermass_y
      ,ggg.globalid
      ,(SELECT ST_UNION(gggg.shape) FROM cipsrv_wbd.wbd_hu12_nphr gggg WHERE SUBSTR(gggg.huc12,1,4) = '2204') AS shape
      FROM
      cipsrv_wbd.wbd_hu12_nphr ggg
      WHERE
      SUBSTR(ggg.huc12,1,4) = '2204'
...
FROM (
   ...
   FROM (
      ...
      ,ggg.centermass_y
      ,ggg.globalid
      ,(SELECT ST_UNION(gggg.shape) FROM cipsrv_wbd.wbd_hu12sp_nphr gggg WHERE SUBSTR(gggg.huc12,1,4) = '2204') AS shape
      FROM
      cipsrv_wbd.wbd_hu12sp_nphr ggg
      WHERE
      SUBSTR(ggg.huc12,1,4) = '2204'

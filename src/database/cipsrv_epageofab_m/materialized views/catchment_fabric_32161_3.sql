DROP MATERIALIZED VIEW IF EXISTS cipsrv_epageofab_m.catchment_fabric_32161_3 CASCADE;

DROP SEQUENCE IF EXISTS cipsrv_epageofab_m.catchment_fabric_32161_3_seq;
CREATE SEQUENCE cipsrv_epageofab_m.catchment_fabric_32161_3_seq START WITH 1;

CREATE MATERIALIZED VIEW cipsrv_epageofab_m.catchment_fabric_32161_3(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
AS
SELECT
 NEXTVAL('cipsrv_epageofab_m.catchment_fabric_32161_3_seq')::INTEGER AS objectid
...
ON cipsrv_epageofab_m.catchment_fabric_32161_3(catchmentstatecode,nhdplusid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_32161_3_u01
ON cipsrv_epageofab_m.catchment_fabric_32161_3(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_32161_3_u02
ON cipsrv_epageofab_m.catchment_fabric_32161_3(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_32161_3_01i
ON cipsrv_epageofab_m.catchment_fabric_32161_3(catchmentstatecode);

CREATE INDEX IF NOT EXISTS catchment_fabric_32161_3_02i
ON cipsrv_epageofab_m.catchment_fabric_32161_3(nhdplusid);

CREATE INDEX IF NOT EXISTS catchment_fabric_32161_3_spx
ON cipsrv_epageofab_m.catchment_fabric_32161_3 USING gist(shape);

ANALYZE cipsrv_epageofab_m.catchment_fabric_32161_3;

--VACUUM FREEZE ANALYZE cipsrv_epageofab_m.catchment_fabric_32161_3;

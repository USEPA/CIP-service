DROP MATERIALIZED VIEW IF EXISTS cipsrv_epageofab_m.catchment_fabric_3338_1 CASCADE;

DROP SEQUENCE IF EXISTS cipsrv_epageofab_m.catchment_fabric_3338_1_seq;
CREATE SEQUENCE cipsrv_epageofab_m.catchment_fabric_3338_1_seq START WITH 1;

CREATE MATERIALIZED VIEW cipsrv_epageofab_m.catchment_fabric_3338_1(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
ALTER TABLE cipsrv_epageofab_m.catchment_fabric_3338_1 OWNER TO cipsrv;
GRANT SELECT ON cipsrv_epageofab_m.catchment_fabric_3338_1 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_3338_1_pk
ON cipsrv_epageofab_m.catchment_fabric_3338_1(nhdplusid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_3338_1_u01
ON cipsrv_epageofab_m.catchment_fabric_3338_1(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_3338_1_u02
ON cipsrv_epageofab_m.catchment_fabric_3338_1(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_3338_1_spx
ON cipsrv_epageofab_m.catchment_fabric_3338_1 USING gist(shape);

ANALYZE cipsrv_epageofab_m.catchment_fabric_3338_1;

--VACUUM FREEZE ANALYZE cipsrv_epageofab_m.catchment_fabric_3338_1;

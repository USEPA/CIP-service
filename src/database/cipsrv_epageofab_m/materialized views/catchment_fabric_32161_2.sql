DROP MATERIALIZED VIEW IF EXISTS cipsrv_epageofab_m.catchment_fabric_32161_2 CASCADE;

DROP SEQUENCE IF EXISTS cipsrv_epageofab_m.catchment_fabric_32161_2_seq;
CREATE SEQUENCE cipsrv_epageofab_m.catchment_fabric_32161_2_seq START WITH 1;

CREATE MATERIALIZED VIEW cipsrv_epageofab_m.catchment_fabric_32161_2(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
WITH 
 tribalcatchments AS (
   ...
   JOIN
   cipsrv_epageofab_m.catchment_fabric_32161_1 bb
   ON
...
SELECT
 NEXTVAL('cipsrv_epageofab_m.catchment_fabric_32161_2_seq')::INTEGER AS objectid
...
ALTER TABLE cipsrv_epageofab_m.catchment_fabric_32161_2 OWNER TO cipsrv;
GRANT SELECT ON cipsrv_epageofab_m.catchment_fabric_32161_2 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_32161_2_pk
ON cipsrv_epageofab_m.catchment_fabric_32161_2(nhdplusid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_32161_2_u01
ON cipsrv_epageofab_m.catchment_fabric_32161_2(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_32161_2_u02
ON cipsrv_epageofab_m.catchment_fabric_32161_2(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_32161_2_spx
ON cipsrv_epageofab_m.catchment_fabric_32161_2 USING gist(shape);

ANALYZE cipsrv_epageofab_m.catchment_fabric_32161_2;

--VACUUM FREEZE ANALYZE cipsrv_epageofab_m.catchment_fabric_32161_2;

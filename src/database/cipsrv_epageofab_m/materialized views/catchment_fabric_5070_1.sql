...
DROP SEQUENCE IF EXISTS cipsrv_epageofab_m.catchment_fabric_5070_1_seq;
CREATE SEQUENCE cipsrv_epageofab_m.catchment_fabric_5070_1_seq START WITH 1;
...
AS
SELECT
 NEXTVAL('cipsrv_epageofab_m.catchment_fabric_5070_1_seq')::INTEGER AS objectid

...
DROP MATERIALIZED VIEW IF EXISTS cipdev_epageofab_h.catchment_fabric_5070_3alt4 CASCADE;

DROP SEQUENCE IF EXISTS cipdev_epageofab_h.catchment_fabric_5070_3alt4_seq;
CREATE SEQUENCE cipdev_epageofab_h.catchment_fabric_5070_3alt4_seq START WITH 1;

-------------------------------------------------------------------------------
-- ('AL','AR','AZ','CA','CO','CT','DC','DE') --
DROP MATERIALIZED VIEW IF EXISTS cipdev_epageofab_h.catchment_fabric_5070_3alt4ad CASCADE;

CREATE MATERIALIZED VIEW cipdev_epageofab_h.catchment_fabric_5070_3alt4ad(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
AS
SELECT
 NEXTVAL('cipdev_epageofab_h.catchment_fabric_5070_3alt4_seq')::INTEGER AS objectid
...
FROM (
   ...
   JOIN
   cipdev_epageofab_h.catchment_fabric_5070_3alt3 bb
   ON
   ...
   FROM
   cipdev_epageofab_h.catchment_fabric_5070_2 cc
   JOIN
   cipdev_epageofab_h.catchment_fabric_5070_3alt3 dd
   ON
...
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4ad(catchmentstatecode,nhdplusid);

-------------------------------------------------------------------------------
-- ('FL','GA','HI','ID','IL','IN','IA') --
DROP MATERIALIZED VIEW IF EXISTS cipdev_epageofab_h.catchment_fabric_5070_3alt4fi CASCADE;

CREATE MATERIALIZED VIEW cipdev_epageofab_h.catchment_fabric_5070_3alt4fi(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4fi(catchmentstatecode,nhdplusid);

-------------------------------------------------------------------------------
-- ('KS','KY','LA','MA','MD','ME','MI','MN','MO','MS','MT') --
DROP MATERIALIZED VIEW IF EXISTS cipdev_epageofab_h.catchment_fabric_5070_3alt4km CASCADE;

CREATE MATERIALIZED VIEW cipdev_epageofab_h.catchment_fabric_5070_3alt4km(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4km(catchmentstatecode,nhdplusid);

-------------------------------------------------------------------------------
-- ('NC','ND','NE','NH','NJ','NM','NV','NY','OH','OK','OR','PA') --
DROP MATERIALIZED VIEW IF EXISTS cipdev_epageofab_h.catchment_fabric_5070_3alt4np CASCADE;

CREATE MATERIALIZED VIEW cipdev_epageofab_h.catchment_fabric_5070_3alt4np(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4np(catchmentstatecode,nhdplusid);

-------------------------------------------------------------------------------
-- ('RI','SC','SD','TN','TX','UT','VA','VT','WA','WV','WI','WY') --
DROP MATERIALIZED VIEW IF EXISTS cipdev_epageofab_h.catchment_fabric_5070_3alt4rw CASCADE;

CREATE MATERIALIZED VIEW cipdev_epageofab_h.catchment_fabric_5070_3alt4rw(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4rw(catchmentstatecode,nhdplusid);

-------------------------------------------------------------------------------
-- ('CN','MX','OW') --
DROP MATERIALIZED VIEW IF EXISTS cipdev_epageofab_h.catchment_fabric_5070_3alt4ow CASCADE;

CREATE MATERIALIZED VIEW cipdev_epageofab_h.catchment_fabric_5070_3alt4ow(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4ow(catchmentstatecode,nhdplusid);

-------------------------------------------------------------------------------
--- Combine into final results
CREATE MATERIALIZED VIEW cipdev_epageofab_h.catchment_fabric_5070_3alt4(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
a.*
FROM 
cipdev_epageofab_h.catchment_fabric_5070_3alt4ad a
UNION ALL
SELECT
b.*
FROM 
cipdev_epageofab_h.catchment_fabric_5070_3alt4fi b
UNION ALL
SELECT
c.*
FROM 
cipdev_epageofab_h.catchment_fabric_5070_3alt4km c
UNION ALL
SELECT
d.*
FROM 
cipdev_epageofab_h.catchment_fabric_5070_3alt4np d
UNION ALL
SELECT
e.*
FROM 
cipdev_epageofab_h.catchment_fabric_5070_3alt4rw e
UNION ALL
SELECT
f.*
FROM 
cipdev_epageofab_h.catchment_fabric_5070_3alt4ow f;

ALTER TABLE cipdev_epageofab_h.catchment_fabric_5070_3alt4 OWNER TO cipsrv;
GRANT SELECT ON cipdev_epageofab_h.catchment_fabric_5070_3alt4 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_5070_3alt4_pk
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4(catchmentstatecode,nhdplusid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_5070_3alt4_u01
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_5070_3alt4_u02
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_5070_3alt4_01i
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4(catchmentstatecode);

CREATE INDEX IF NOT EXISTS catchment_fabric_5070_3alt4_02i
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4(nhdplusid);

CREATE INDEX IF NOT EXISTS catchment_fabric_5070_3alt4_spx
ON cipdev_epageofab_h.catchment_fabric_5070_3alt4 USING gist(shape);

ANALYZE cipdev_epageofab_h.catchment_fabric_5070_3alt4;

--VACUUM FREEZE ANALYZE cipdev_epageofab_h.catchment_fabric_5070_3alt4;

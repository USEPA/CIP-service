DROP MATERIALIZED VIEW IF EXISTS cipdev_epageofab_h.tw_nhdflowline_32655 CASCADE;

CREATE MATERIALIZED VIEW cipdev_epageofab_h.tw_nhdflowline_32655(
    objectid
   ,statecode
   ,nhdplusid
...
ALTER TABLE cipdev_epageofab_h.tw_nhdflowline_32655 OWNER TO cipsrv;
GRANT SELECT ON cipdev_epageofab_h.tw_nhdflowline_32655 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS tw_nhdflowline_32655_pk
ON cipdev_epageofab_h.tw_nhdflowline_32655(statecode,nhdplusid);

CREATE UNIQUE INDEX IF NOT EXISTS tw_nhdflowline_32655_u01
ON cipdev_epageofab_h.tw_nhdflowline_32655(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS tw_nhdflowline_32655_u02
ON cipdev_epageofab_h.tw_nhdflowline_32655(globalid);

CREATE INDEX IF NOT EXISTS tw_nhdflowline_32655_01i
ON cipdev_epageofab_h.tw_nhdflowline_32655(statecode);

CREATE INDEX IF NOT EXISTS tw_nhdflowline_32655_02i
ON cipdev_epageofab_h.tw_nhdflowline_32655(nhdplusid);

CREATE INDEX IF NOT EXISTS tw_nhdflowline_32655_spx
ON cipdev_epageofab_h.tw_nhdflowline_32655 USING gist(shape);

ANALYZE cipdev_epageofab_h.tw_nhdflowline_32655;

--VACUUM FREEZE ANALYZE cipdev_epageofab_h.tw_nhdflowline_32655;

DROP MATERIALIZED VIEW IF EXISTS cipdev_epageofab_h.catchment_fabric_5070_2 CASCADE;

DROP SEQUENCE IF EXISTS cipdev_epageofab_h.catchment_fabric_5070_2_seq;
CREATE SEQUENCE cipdev_epageofab_h.catchment_fabric_5070_2_seq START WITH 1;

CREATE MATERIALIZED VIEW cipdev_epageofab_h.catchment_fabric_5070_2(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
 ...
 tribalcatchments AS (
   ...
   FROM (
      ...
      FROM (
         ...
         FROM 
         cipdev_epageofab_h.catchment_fabric_5070_1 aaaa
         INNER JOIN LATERAL (
            SELECT
             bbbbb.geoid
            ,bbbbb.shape
   ...
   JOIN
   cipdev_epageofab_h.catchment_fabric_5070_1 bb
   ON
...
SELECT
 NEXTVAL('cipdev_epageofab_h.catchment_fabric_5070_2_seq')::INTEGER AS objectid
...
ALTER TABLE cipdev_epageofab_h.catchment_fabric_5070_2 OWNER TO cipsrv;
GRANT SELECT ON cipdev_epageofab_h.catchment_fabric_5070_2 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_5070_2_pk
ON cipdev_epageofab_h.catchment_fabric_5070_2(nhdplusid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_5070_2_u01
ON cipdev_epageofab_h.catchment_fabric_5070_2(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_5070_2_u02
ON cipdev_epageofab_h.catchment_fabric_5070_2(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_5070_2_spx
ON cipdev_epageofab_h.catchment_fabric_5070_2 USING gist(shape);

ANALYZE cipdev_epageofab_h.catchment_fabric_5070_2;

--VACUUM FREEZE ANALYZE cipdev_epageofab_h.catchment_fabric_5070_2;

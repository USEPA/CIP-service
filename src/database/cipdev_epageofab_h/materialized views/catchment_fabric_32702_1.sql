DROP MATERIALIZED VIEW IF EXISTS cipdev_epageofab_h.catchment_fabric_32702_1 CASCADE;

DROP SEQUENCE IF EXISTS cipdev_epageofab_h.catchment_fabric_32702_1_seq;
CREATE SEQUENCE cipdev_epageofab_h.catchment_fabric_32702_1_seq START WITH 1;

CREATE MATERIALIZED VIEW cipdev_epageofab_h.catchment_fabric_32702_1(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
AS
SELECT
 NEXTVAL('cipdev_epageofab_h.catchment_fabric_32702_1_seq')::INTEGER AS objectid
...
ALTER TABLE cipdev_epageofab_h.catchment_fabric_32702_1 OWNER TO cipsrv;
GRANT SELECT ON cipdev_epageofab_h.catchment_fabric_32702_1 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_32702_1_pk
ON cipdev_epageofab_h.catchment_fabric_32702_1(nhdplusid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_32702_1_u01
ON cipdev_epageofab_h.catchment_fabric_32702_1(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_32702_1_u02
ON cipdev_epageofab_h.catchment_fabric_32702_1(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_32702_1_spx
ON cipdev_epageofab_h.catchment_fabric_32702_1 USING gist(shape);

ANALYZE cipdev_epageofab_h.catchment_fabric_32702_1;

--VACUUM FREEZE ANALYZE cipdev_epageofab_h.catchment_fabric_32702_1;

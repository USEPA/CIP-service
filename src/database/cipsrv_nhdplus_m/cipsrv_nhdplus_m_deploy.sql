...
DROP SEQUENCE IF EXISTS cipsrv_nhdplus_m.catchment_3338_seq;
...
DROP SEQUENCE IF EXISTS cipsrv_nhdplus_m.catchment_5070_seq;
CREATE SEQUENCE IF NOT EXISTS cipsrv_nhdplus_m.catchment_5070_seq START WITH 1;
...
ON cipsrv_nhdplus_m.catchment_5070(catchmentstatecodes,nhdplusid);

CREATE UNIQUE INDEX catchment_5070_02u
ON cipsrv_nhdplus_m.catchment_5070(catchmentstatecodes,hydroseq);

CREATE UNIQUE INDEX catchment_5070_03u
ON cipsrv_nhdplus_m.catchment_5070(objectid);
...
ON cipsrv_nhdplus_m.catchment_5070(statesplit);
...
ON cipsrv_nhdplus_m.catchment_5070 USING GIN(catchmentstatecodes);
...
ON cipsrv_nhdplus_m.catchment_32161(catchmentstatecodes,nhdplusid);

CREATE UNIQUE INDEX catchment_32161_02u
ON cipsrv_nhdplus_m.catchment_32161(catchmentstatecodes,hydroseq);

CREATE UNIQUE INDEX catchment_32161_03u
ON cipsrv_nhdplus_m.catchment_32161(objectid);
...
ON cipsrv_nhdplus_m.catchment_32161(statesplit);
...
ON cipsrv_nhdplus_m.catchment_32161 USING GIN(catchmentstatecodes);
...
DROP SEQUENCE IF EXISTS cipsrv_nhdplus_m.catchment_32655_seq;
CREATE SEQUENCE IF NOT EXISTS cipsrv_nhdplus_m.catchment_32655_seq START WITH 1;
...
ON cipsrv_nhdplus_m.catchment_32655(catchmentstatecodes,nhdplusid);

CREATE UNIQUE INDEX catchment_32655_02u
ON cipsrv_nhdplus_m.catchment_32655(catchmentstatecodes,hydroseq);

CREATE UNIQUE INDEX catchment_32655_03u
ON cipsrv_nhdplus_m.catchment_32655(objectid);
...
ON cipsrv_nhdplus_m.catchment_32655 USING GIN(catchmentstatecodes);
...
DROP SEQUENCE IF EXISTS cipsrv_nhdplus_m.catchment_32702_seq;
CREATE SEQUENCE IF NOT EXISTS cipsrv_nhdplus_m.catchment_32702_seq START WITH 1;
...
ON cipsrv_nhdplus_m.catchment_32702(catchmentstatecodes,nhdplusid);

CREATE UNIQUE INDEX catchment_32702_02u
ON cipsrv_nhdplus_m.catchment_32702(catchmentstatecodes,hydroseq);

CREATE UNIQUE INDEX catchment_32702_03u
ON cipsrv_nhdplus_m.catchment_32702(objectid);
...
ON cipsrv_nhdplus_m.catchment_32702(statesplit);
...
ON cipsrv_nhdplus_m.catchment_32702 USING GIN(catchmentstatecodes);
...
DROP SEQUENCE IF EXISTS cipsrv_nhdplus_m.nhdflowline_3338_seq;
CREATE SEQUENCE IF NOT EXISTS cipsrv_nhdplus_m.nhdflowline_3338_seq START WITH 1;
...
AS
SELECT
 NEXTVAL('cipsrv_nhdplus_m.nhdflowline_3338_seq') AS objectid
...
ON cipsrv_nhdplus_m.nhdflowline_3338(objectid);
...
DROP SEQUENCE IF EXISTS cipsrv_nhdplus_m.nhdflowline_5070_seq;
CREATE SEQUENCE IF NOT EXISTS cipsrv_nhdplus_m.nhdflowline_5070_seq START WITH 1;
...
AS
SELECT
 NEXTVAL('cipsrv_nhdplus_m.nhdflowline_5070_seq') AS objectid
,a.permanent_identifier
,a.fdate
,a.resolution
,a.gnis_id
...
cipsrv_nhdplus_m.nonnetworknhdflowline b
WHERE
b.vpuid NOT IN ('19','20','21','22A','22G','22M');
...
DROP SEQUENCE IF EXISTS cipsrv_nhdplus_m.nhdflowline_32702_seq;
CREATE SEQUENCE IF NOT EXISTS cipsrv_nhdplus_m.nhdflowline_32702_seq START WITH 1;
...
AS
SELECT
 NEXTVAL('cipsrv_nhdplus_m.nhdflowline_32702_seq') AS objectid
,a.permanent_identifier
,a.fdate
,a.resolution
,a.gnis_id
...
CREATE OR REPLACE VIEW cipsrv_nhdplus_m.catchment_5070_state
AS
SELECT
a.*
FROM
...
ALTER TABLE cipsrv_nhdplus_m.catchment_5070_state OWNER TO cipsrv;
GRANT SELECT ON cipsrv_nhdplus_m.catchment_5070_state TO public;
--******************************--
----- views/catchment_26904_full.sql 

CREATE OR REPLACE VIEW cipsrv_nhdplus_m.catchment_26904_full
AS
SELECT
a.*
FROM
...
ALTER TABLE cipsrv_nhdplus_m.catchment_26904_full OWNER TO cipsrv;
GRANT SELECT ON cipsrv_nhdplus_m.catchment_26904_full TO public;
--******************************--
...
CREATE OR REPLACE VIEW cipsrv_nhdplus_m.catchment_32702_state
AS
SELECT
a.*
FROM
...
BEGIN
   ...
   ELSE
      ...
      THEN
         str_source_table := 'cipsrv_nhdplus_m.catchment_5070';

      ELSIF int_raster_srid = 3338
      THEN
         str_source_table := 'cipsrv_nhdplus_m.catchment_3338';
         
      ELSIF int_raster_srid = 26904
      THEN
         str_source_table := 'cipsrv_nhdplus_m.catchment_26904';
         
      ELSIF int_raster_srid = 32161
      THEN
         str_source_table := 'cipsrv_nhdplus_m.catchment_32161';
         
      ELSIF int_raster_srid = 32655
      THEN
         str_source_table := 'cipsrv_nhdplus_m.catchment_32655';
         
      ELSIF int_raster_srid = 32702
      THEN
         str_source_table := 'cipsrv_nhdplus_m.catchment_32702';
   ...
   IF int_raster_srid = 5070
   THEN
      str_source_table := 'cipsrv_nhdplus_m.nhdflowline_5070';

   ELSIF int_raster_srid = 3338
   THEN
      str_source_table := 'cipsrv_nhdplus_m.nhdflowline_3338';
   
   ELSIF int_raster_srid = 26904
   THEN
      str_source_table := 'cipsrv_nhdplus_m.nhdflowline_26904';
      
   ELSIF int_raster_srid = 32161
   THEN
      str_source_table := 'cipsrv_nhdplus_m.nhdflowline_32161';
      
   ELSIF int_raster_srid = 32655
   THEN
      str_source_table := 'cipsrv_nhdplus_m.nhdflowline_32655';
      
   ELSIF int_raster_srid = 32702
   THEN
      str_source_table := 'cipsrv_nhdplus_m.nhdflowline_32702';
...
--raise warning 'out_return_flowlines: %',out_return_flowlines;
   ...
   AND NOT boo_zero_length_delin
   THEN
      rec := cipsrv_nhdplus_m.delineation_preprocessing(
   ...
   THEN
      ...
      sdo_split_catchment := cipsrv_nhdplus_m.split_catchment(
   ...
   THEN
      IF boo_topology_flag
      THEN
         rec := cipsrv_nhdplus_m.load_topo_catchment(
      ...
      ELSE
         rec := cipsrv_nhdplus_m.load_aggregated_catchment(
             p_grid_srid       := out_grid_srid
         );
         out_return_code     := rec.out_return_code;
         out_status_message  := rec.out_status_message;
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.delineation_preprocessing';
   IF b IS NOT NULL THEN 
   EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);ELSE
   IF a IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s',a);END IF;END IF;
END$$;
...
BEGIN
   ...
   THEN
      ...
      THEN      
         ...
         JOIN
         cipsrv_nhdplus_m.catchment_5070_full b
         ON
      ...
      THEN      
         ...
         tmp_navigation_results a
         JOIN
         cipsrv_nhdplus_m.catchment_3338_full b
         ON
         b.nhdplusid = a.nhdplusid;
      ...
      THEN      
         ...
         tmp_navigation_results a
         JOIN
         cipsrv_nhdplus_m.catchment_26904_full b
         ON
         b.nhdplusid = a.nhdplusid;
      ...
      THEN      
         ...
         tmp_navigation_results a
         JOIN
         cipsrv_nhdplus_m.catchment_32161_full b
         ON
         b.nhdplusid = a.nhdplusid;
      ...
      THEN      
         ...
         tmp_navigation_results a
         JOIN
         cipsrv_nhdplus_m.catchment_32655_full b
         ON
         b.nhdplusid = a.nhdplusid;
      ...
      THEN      
         ...
         tmp_navigation_results a
         JOIN
         cipsrv_nhdplus_m.catchment_32702_full b
         ON
         b.nhdplusid = a.nhdplusid;
...
ALTER FUNCTION cipsrv_nhdplus_m.delineation_preprocessing(
    BOOLEAN
   ,INTEGER
   ,BOOLEAN
   ,BOOLEAN
...
GRANT EXECUTE ON FUNCTION cipsrv_nhdplus_m.delineation_preprocessing(
    BOOLEAN
   ,INTEGER
   ,BOOLEAN
   ,BOOLEAN
...
CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.fetch_grids_by_geometry(
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.get_measure';
   IF b IS NOT NULL THEN 
   EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);ELSE
   IF a IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s',a);END IF;END IF;
END$$;

CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.get_measure(
...
EXCEPTION
   ...
   THEN
      out_return_code    := -10;
      out_status_message := 'no results found in cipsrv_nhdplus_m networknhdflowline';
      RETURN;
...
--******************************--
----- functions/fdr_flowaccumulation.sql 
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.fdr_flowaccumulation';
   IF b IS NOT NULL THEN 
   EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);ELSE
   IF a IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s',a);END IF;END IF;
END$$;
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.index_area_artpath';
   IF b IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);END IF;
END$$;
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.index_area_centroid';
   IF b IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);END IF;
END$$;
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.index_line_simple';
   IF b IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);END IF;
END$$;
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.measure_lengthkm';
   IF b IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);END IF;
END$$;

CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.measure_lengthkm(
    IN  p_geometry          GEOMETRY
   ,IN  p_known_region      VARCHAR DEFAULT NULL
) RETURNS NUMERIC
STABLE
...
ALTER FUNCTION cipsrv_nhdplus_m.measure_lengthkm(
    GEOMETRY
   ,VARCHAR
) OWNER TO cipsrv;

GRANT EXECUTE ON FUNCTION cipsrv_nhdplus_m.measure_lengthkm(
    GEOMETRY
   ,VARCHAR
) TO PUBLIC;
...
CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.nav_dd(
...
CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.nav_dm(
    IN  obj_start_flowline       cipsrv_nhdplus_m.flowline
   ,IN  num_maximum_distancekm   NUMERIC
   ,IN  num_maximum_flowtimeday  NUMERIC
) RETURNS INTEGER
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.point_at_measure';
   IF b IS NOT NULL THEN 
   EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);ELSE
   IF a IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s',a);END IF;END IF;
END$$;
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.raindrop_coord_to_raster';
   IF b IS NOT NULL THEN
   EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);ELSE
   IF a IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s',a);END IF;END IF;
END$$;

CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.raindrop_coord_to_raster(
...
ALTER FUNCTION cipsrv_nhdplus_m.raindrop_coord_to_raster(
    INTEGER
   ,INTEGER
   ,VARCHAR
) OWNER TO cipsrv;

GRANT EXECUTE ON FUNCTION cipsrv_nhdplus_m.raindrop_coord_to_raster(
    INTEGER
   ,INTEGER
   ,VARCHAR
) TO PUBLIC;
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.raindrop_next_coordinate';
   IF b IS NOT NULL THEN
   EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);ELSE
   IF a IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s',a);END IF;END IF;
END$$;

CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.raindrop_next_coordinate(
    IN    p_raster                 RASTER
...
BEGIN
   ...
   --------------------------------------------------------------------------
   out_direction := cipsrv_nhdplus_m.raindrop_st_value(
       p_raster    := p_raster
...
ALTER FUNCTION cipsrv_nhdplus_m.raindrop_next_coordinate(
    RASTER
   ,NUMERIC
   ,INTEGER
   ,INTEGER
...
GRANT EXECUTE ON FUNCTION cipsrv_nhdplus_m.raindrop_next_coordinate(
    RASTER
   ,NUMERIC
   ,INTEGER
   ,INTEGER
...
CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.randomcatchment(
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.randomnav';
   IF b IS NOT NULL THEN 
   EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);ELSE
   IF a IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s',a);END IF;END IF;
END$$;

CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.randomnav(
    IN  p_region               VARCHAR DEFAULT NULL
   ,IN  p_return_geometry      BOOLEAN DEFAULT FALSE
   ,OUT out_nhdplusid          BIGINT
   ,OUT out_reachcode          VARCHAR
...
ALTER FUNCTION cipsrv_nhdplus_m.randomnav(
    VARCHAR
   ,BOOLEAN
) OWNER TO cipsrv;

GRANT EXECUTE ON FUNCTION cipsrv_nhdplus_m.randomnav(
    VARCHAR
   ,BOOLEAN
) TO PUBLIC;
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.randomppnav';
   IF b IS NOT NULL THEN 
   EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);ELSE
   IF a IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s',a);END IF;END IF;
END$$;

CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.randomppnav(
    IN  p_region               VARCHAR DEFAULT NULL
   ,IN  p_return_geometry      BOOLEAN DEFAULT FALSE
...
ALTER FUNCTION cipsrv_nhdplus_m.randomppnav(
    VARCHAR
   ,BOOLEAN
) OWNER TO cipsrv;

GRANT EXECUTE ON FUNCTION cipsrv_nhdplus_m.randomppnav(
    VARCHAR
   ,BOOLEAN
) TO PUBLIC;
...
BEGIN
   SELECT p.oid::regproc,pg_get_function_identity_arguments(p.oid)
   INTO a,b FROM pg_catalog.pg_proc p LEFT JOIN pg_catalog.pg_namespace n ON n.oid = p.pronamespace
   WHERE p.oid::regproc::text = 'cipsrv_nhdplus_m.snapflowline2geojson';
   IF b IS NOT NULL THEN 
   EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s(%s)',a,b);ELSE
   IF a IS NOT NULL THEN EXECUTE FORMAT('DROP FUNCTION IF EXISTS %s',a);END IF;END IF;
END$$;

CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.snapflowline2geojson(
...
ALTER FUNCTION cipsrv_nhdplus_m.snapflowline2geojson(
    cipsrv_nhdplus_m.snapflowline
) OWNER TO cipsrv;

GRANT EXECUTE ON FUNCTION cipsrv_nhdplus_m.snapflowline2geojson(
    cipsrv_nhdplus_m.snapflowline
) TO PUBLIC;
--******************************--
...
BEGIN
   ...
   RETURN JSONB_BUILD_OBJECT(
      ...
      ,'features'            ,(
         SELECT
         array_agg(cipsrv_nhdplus_m.snapflowline2geojson(x))
         FROM
         UNNEST(p_input) AS x
      )
   );
...
CREATE OR REPLACE FUNCTION cipsrv_nhdplus_m.top_of_flow(
    IN  p_nhdplusid                 BIGINT
   ,IN  p_permanent_identifier      VARCHAR
   ,IN  p_reachcode                 VARCHAR
   ,IN  p_known_region              VARCHAR
   ...
   THEN
      ...
      THEN
         ...
         THEN 
            ...
            sdo_flowline
            FROM
            cipsrv_nhdplus_m.nhdflowline_5070 a
            WHERE
                a.nhdplusid = p_nhdplusid
         ...
         THEN 
            ...
            sdo_flowline
            FROM
            cipsrv_nhdplus_m.nhdflowline_3338 a
            WHERE
                a.nhdplusid = p_nhdplusid
            AND ST_Intersects(a.shape,sdo_polygon_mask);
         ...
         THEN
            ...
            sdo_flowline
            FROM
            cipsrv_nhdplus_m.nhdflowline_26904 a
            WHERE
                a.nhdplusid = p_nhdplusid
            AND ST_Intersects(a.shape,sdo_polygon_mask);
         ...
         THEN
            ...
            sdo_flowline
            FROM
            cipsrv_nhdplus_m.nhdflowline_32161 a
            WHERE
                a.nhdplusid = p_nhdplusid
            AND ST_Intersects(a.shape,sdo_polygon_mask);
         ...
         THEN
            ...
            sdo_flowline
            FROM
            cipsrv_nhdplus_m.nhdflowline_32655 a
            WHERE
                a.nhdplusid = p_nhdplusid
            AND ST_Intersects(a.shape,sdo_polygon_mask);
         ...
         THEN
            ...
            sdo_flowline
            FROM
            cipsrv_nhdplus_m.nhdflowline_32702 a
            WHERE
                a.nhdplusid = p_nhdplusid
            AND ST_Intersects(a.shape,sdo_polygon_mask);

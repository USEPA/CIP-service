DROP MATERIALIZED VIEW IF EXISTS cipdev_wbd.wbd_hu10_nphr_32655 CASCADE;

CREATE MATERIALIZED VIEW cipdev_wbd.wbd_hu10_nphr_32655(
    objectid
   ,tnmid
   ,metasourceid
   ,loaddate
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipdev_wbd.wbd_hu12_nphr_32655 aaaa
      ) aaa
      CROSS JOIN
...
ALTER TABLE cipdev_wbd.wbd_hu10_nphr_32655 OWNER TO cipsrv;
GRANT SELECT ON cipdev_wbd.wbd_hu10_nphr_32655 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu10_nphr_32655_pk
ON cipdev_wbd.wbd_hu10_nphr_32655(huc10);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu10_nphr_32655_u01
ON cipdev_wbd.wbd_hu10_nphr_32655(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu10_nphr_32655_u02
ON cipdev_wbd.wbd_hu10_nphr_32655(globalid);

CREATE INDEX IF NOT EXISTS wbd_hu10_nphr_32655_f01
ON cipdev_wbd.wbd_hu10_nphr_32655(SUBSTR(huc10,1,2));

CREATE INDEX IF NOT EXISTS wbd_hu10_nphr_32655_f02
ON cipdev_wbd.wbd_hu10_nphr_32655(SUBSTR(huc10,1,4));

CREATE INDEX IF NOT EXISTS wbd_hu10_nphr_32655_f03
ON cipdev_wbd.wbd_hu10_nphr_32655(SUBSTR(huc10,1,6));

CREATE INDEX IF NOT EXISTS wbd_hu10_nphr_32655_f04
ON cipdev_wbd.wbd_hu10_nphr_32655(SUBSTR(huc10,1,8));

CREATE INDEX IF NOT EXISTS wbd_hu10_nphr_32655_spx
ON cipdev_wbd.wbd_hu10_nphr_32655 USING gist(shape);

ANALYZE cipdev_wbd.wbd_hu10_nphr_32655;

--VACUUM FREEZE ANALYZE cipdev_wbd.wbd_hu10_nphr_32655;

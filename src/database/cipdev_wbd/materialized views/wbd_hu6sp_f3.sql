DROP MATERIALIZED VIEW IF EXISTS cipdev_wbd.wbd_hu6sp_f3 CASCADE;

CREATE MATERIALIZED VIEW cipdev_wbd.wbd_hu6sp_f3(
    objectid
   ,tnmid
   ,metasourceid
   ,loaddate
...
ALTER TABLE cipdev_wbd.wbd_hu6sp_f3 OWNER TO cipsrv;
GRANT SELECT ON cipdev_wbd.wbd_hu6sp_f3 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu6sp_f3_pk
ON cipdev_wbd.wbd_hu6sp_f3(huc6);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu6sp_f3_u01
ON cipdev_wbd.wbd_hu6sp_f3(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu6sp_f3_u02
ON cipdev_wbd.wbd_hu6sp_f3(globalid);

CREATE INDEX IF NOT EXISTS wbd_hu6sp_f3_f01
ON cipdev_wbd.wbd_hu6sp_f3(SUBSTR(huc6,1,2));

CREATE INDEX IF NOT EXISTS wbd_hu6sp_f3_f02
ON cipdev_wbd.wbd_hu6sp_f3(SUBSTR(huc6,1,4));

CREATE INDEX IF NOT EXISTS wbd_hu6sp_f3_spx
ON cipdev_wbd.wbd_hu6sp_f3 USING gist(shape);

ANALYZE cipdev_wbd.wbd_hu6sp_f3;

--VACUUM FREEZE ANALYZE cipdev_wbd.wbd_hu6sp_f3;

DROP MATERIALIZED VIEW IF EXISTS cipdev_wbd.wbd_hu6_nphr_5070 CASCADE;

CREATE MATERIALIZED VIEW cipdev_wbd.wbd_hu6_nphr_5070(
    objectid
   ,tnmid
   ,metasourceid
   ,loaddate
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipdev_wbd.wbd_hu8_nphr_5070 aaaa
      ) aaa
      CROSS JOIN
...
ALTER TABLE cipdev_wbd.wbd_hu6_nphr_5070 OWNER TO cipsrv;
GRANT SELECT ON cipdev_wbd.wbd_hu6_nphr_5070 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu6_nphr_5070_pk
ON cipdev_wbd.wbd_hu6_nphr_5070(huc6);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu6_nphr_5070_u01
ON cipdev_wbd.wbd_hu6_nphr_5070(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu6_nphr_5070_u02
ON cipdev_wbd.wbd_hu6_nphr_5070(globalid);

CREATE INDEX IF NOT EXISTS wbd_hu6_nphr_5070_f01
ON cipdev_wbd.wbd_hu6_nphr_5070(SUBSTR(huc6,1,2));

CREATE INDEX IF NOT EXISTS wbd_hu6_nphr_5070_f02
ON cipdev_wbd.wbd_hu6_nphr_5070(SUBSTR(huc6,1,4));

CREATE INDEX IF NOT EXISTS wbd_hu6_nphr_5070_spx
ON cipdev_wbd.wbd_hu6_nphr_5070 USING gist(shape);

ANALYZE cipdev_wbd.wbd_hu6_nphr_5070;

--VACUUM FREEZE ANALYZE cipdev_wbd.wbd_hu6_nphr_5070;

DROP MATERIALIZED VIEW IF EXISTS cipdev_wbd.wbd_hu4_nphr_3338 CASCADE;

CREATE MATERIALIZED VIEW cipdev_wbd.wbd_hu4_nphr_3338(
    objectid
   ,tnmid
   ,metasourceid
   ,loaddate
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipdev_wbd.wbd_hu6_nphr_3338 aaaa
      ) aaa
      CROSS JOIN
...
ALTER TABLE cipdev_wbd.wbd_hu4_nphr_3338 OWNER TO cipsrv;
GRANT SELECT ON cipdev_wbd.wbd_hu4_nphr_3338 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu4_nphr_3338_pk
ON cipdev_wbd.wbd_hu4_nphr_3338(huc4);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu4_nphr_3338_u01
ON cipdev_wbd.wbd_hu4_nphr_3338(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu4_nphr_3338_u02
ON cipdev_wbd.wbd_hu4_nphr_3338(globalid);

CREATE INDEX IF NOT EXISTS wbd_hu4_nphr_3338_f01
ON cipdev_wbd.wbd_hu4_nphr_3338(SUBSTR(huc4,1,2));

CREATE INDEX IF NOT EXISTS wbd_hu4_nphr_3338_spx
ON cipdev_wbd.wbd_hu4_nphr_3338 USING gist(shape);

ANALYZE cipdev_wbd.wbd_hu4_nphr_3338;

--VACUUM FREEZE ANALYZE cipdev_wbd.wbd_hu4_nphr_3338;

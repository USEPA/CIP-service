DROP MATERIALIZED VIEW IF EXISTS cipdev_wbd.wbd_hu10_np21_26904 CASCADE;

CREATE MATERIALIZED VIEW cipdev_wbd.wbd_hu10_np21_26904(
    objectid
   ,tnmid
   ,metasourceid
   ,loaddate
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipdev_wbd.wbd_hu12_np21_26904 aaaa
      ) aaa
      CROSS JOIN
...
ALTER TABLE cipdev_wbd.wbd_hu10_np21_26904 OWNER TO cipsrv;
GRANT SELECT ON cipdev_wbd.wbd_hu10_np21_26904 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu10_np21_26904_pk
ON cipdev_wbd.wbd_hu10_np21_26904(huc10);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu10_np21_26904_u01
ON cipdev_wbd.wbd_hu10_np21_26904(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu10_np21_26904_u02
ON cipdev_wbd.wbd_hu10_np21_26904(globalid);

CREATE INDEX IF NOT EXISTS wbd_hu10_np21_26904_f01
ON cipdev_wbd.wbd_hu10_np21_26904(SUBSTR(huc10,1,2));

CREATE INDEX IF NOT EXISTS wbd_hu10_np21_26904_f02
ON cipdev_wbd.wbd_hu10_np21_26904(SUBSTR(huc10,1,4));

CREATE INDEX IF NOT EXISTS wbd_hu10_np21_26904_f03
ON cipdev_wbd.wbd_hu10_np21_26904(SUBSTR(huc10,1,6));

CREATE INDEX IF NOT EXISTS wbd_hu10_np21_26904_f04
ON cipdev_wbd.wbd_hu10_np21_26904(SUBSTR(huc10,1,8));

CREATE INDEX IF NOT EXISTS wbd_hu10_np21_26904_spx
ON cipdev_wbd.wbd_hu10_np21_26904 USING gist(shape);

ANALYZE cipdev_wbd.wbd_hu10_np21_26904;

--VACUUM FREEZE ANALYZE cipdev_wbd.wbd_hu10_np21_26904;

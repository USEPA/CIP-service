DROP MATERIALIZED VIEW IF EXISTS cipdev_wbd.wbd_hu10_np21_32702 CASCADE;

CREATE MATERIALIZED VIEW cipdev_wbd.wbd_hu10_np21_32702(
    objectid
   ,tnmid
   ,metasourceid
   ,loaddate
...
FROM (
   ...
   FROM (
      ...
      FROM (
         ...
         ,aaaa.shape
         FROM
         cipdev_wbd.wbd_hu12_np21_32702 aaaa
      ) aaa
      CROSS JOIN
...
ALTER TABLE cipdev_wbd.wbd_hu10_np21_32702 OWNER TO cipsrv;
GRANT SELECT ON cipdev_wbd.wbd_hu10_np21_32702 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu10_np21_32702_pk
ON cipdev_wbd.wbd_hu10_np21_32702(huc10);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu10_np21_32702_u01
ON cipdev_wbd.wbd_hu10_np21_32702(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS wbd_hu10_np21_32702_u02
ON cipdev_wbd.wbd_hu10_np21_32702(globalid);

CREATE INDEX IF NOT EXISTS wbd_hu10_np21_32702_f01
ON cipdev_wbd.wbd_hu10_np21_32702(SUBSTR(huc10,1,2));

CREATE INDEX IF NOT EXISTS wbd_hu10_np21_32702_f02
ON cipdev_wbd.wbd_hu10_np21_32702(SUBSTR(huc10,1,4));

CREATE INDEX IF NOT EXISTS wbd_hu10_np21_32702_f03
ON cipdev_wbd.wbd_hu10_np21_32702(SUBSTR(huc10,1,6));

CREATE INDEX IF NOT EXISTS wbd_hu10_np21_32702_f04
ON cipdev_wbd.wbd_hu10_np21_32702(SUBSTR(huc10,1,8));

CREATE INDEX IF NOT EXISTS wbd_hu10_np21_32702_spx
ON cipdev_wbd.wbd_hu10_np21_32702 USING gist(shape);

ANALYZE cipdev_wbd.wbd_hu10_np21_32702;

--VACUUM FREEZE ANALYZE cipdev_wbd.wbd_hu10_np21_32702;

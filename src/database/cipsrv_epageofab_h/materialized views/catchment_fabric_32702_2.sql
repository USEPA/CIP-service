...
WITH 
 tribalcatchments AS (
   ...
   JOIN
   cipsrv_epageofab_h.catchment_fabric_32702_1 bb
   ON
...
ALTER TABLE cipsrv_epageofab_h.catchment_fabric_32702_2 OWNER TO cipsrv;
GRANT SELECT ON cipsrv_epageofab_h.catchment_fabric_32702_2 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_32702_2_pk
ON cipsrv_epageofab_h.catchment_fabric_32702_2(nhdplusid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_32702_2_u01
ON cipsrv_epageofab_h.catchment_fabric_32702_2(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_32702_2_u02
ON cipsrv_epageofab_h.catchment_fabric_32702_2(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_32702_2_spx
ON cipsrv_epageofab_h.catchment_fabric_32702_2 USING gist(shape);

ANALYZE cipsrv_epageofab_h.catchment_fabric_32702_2;

--VACUUM FREEZE ANALYZE cipsrv_epageofab_h.catchment_fabric_32702_2;

...
ALTER TABLE cipsrv_epageofab_h.catchment_fabric_huc12_nphr_final OWNER TO cipsrv;
GRANT SELECT ON cipsrv_epageofab_h.catchment_fabric_huc12_nphr_final TO public;

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_huc12_nphr_final_pk
ON cipsrv_epageofab_h.catchment_fabric_huc12_nphr_final(xwalk_huc12);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_huc12_nphr_final_u01
ON cipsrv_epageofab_h.catchment_fabric_huc12_nphr_final(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_huc12_nphr_final_u02
ON cipsrv_epageofab_h.catchment_fabric_huc12_nphr_final(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_huc12_nphr_final_spx
ON cipsrv_epageofab_h.catchment_fabric_huc12_nphr_final USING gist(shape);

ANALYZE cipsrv_epageofab_h.catchment_fabric_huc12_nphr_final;

--VACUUM FREEZE ANALYZE cipsrv_epageofab_h.catchment_fabric_huc12_nphr_final;

...
DROP SEQUENCE IF EXISTS cipsrv_epageofab_h.catchment_fabric_32161_2_seq;
CREATE SEQUENCE cipsrv_epageofab_h.catchment_fabric_32161_2_seq START WITH 1;
...
SELECT
 NEXTVAL('cipsrv_epageofab_h.catchment_fabric_32161_2_seq')::INTEGER AS objectid

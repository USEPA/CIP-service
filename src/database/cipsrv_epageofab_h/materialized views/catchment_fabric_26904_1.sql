DROP MATERIALIZED VIEW IF EXISTS cipsrv_epageofab_h.catchment_fabric_26904_1 CASCADE;

DROP SEQUENCE IF EXISTS cipsrv_epageofab_h.catchment_fabric_26904_1_seq;
CREATE SEQUENCE cipsrv_epageofab_h.catchment_fabric_26904_1_seq START WITH 1;

CREATE MATERIALIZED VIEW cipsrv_epageofab_h.catchment_fabric_26904_1(
    objectid
   ,catchmentstatecode
   ,nhdplusid
   ,istribal
...
ALTER TABLE cipsrv_epageofab_h.catchment_fabric_26904_1 OWNER TO cipsrv;
GRANT SELECT ON cipsrv_epageofab_h.catchment_fabric_26904_1 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_26904_1_pk
ON cipsrv_epageofab_h.catchment_fabric_26904_1(nhdplusid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_26904_1_u01
ON cipsrv_epageofab_h.catchment_fabric_26904_1(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_26904_1_u02
ON cipsrv_epageofab_h.catchment_fabric_26904_1(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_26904_1_spx
ON cipsrv_epageofab_h.catchment_fabric_26904_1 USING gist(shape);

ANALYZE cipsrv_epageofab_h.catchment_fabric_26904_1;

--VACUUM FREEZE ANALYZE cipsrv_epageofab_h.catchment_fabric_26904_1;

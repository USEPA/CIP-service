...
DROP SEQUENCE IF EXISTS cipsrv_epageofab_h.catchment_fabric_huc12_f3_final_seq;
CREATE SEQUENCE cipsrv_epageofab_h.catchment_fabric_huc12_f3_final_seq START WITH 1;
...
AS
SELECT
 NEXTVAL('cipsrv_epageofab_h.catchment_fabric_huc12_f3_final_seq')::INTEGER AS objectid
,a.xwalk_huc12

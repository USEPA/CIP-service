...
ON cipsrv_epageofab_h.catchment_fabric_26904_3(catchmentstatecode,nhdplusid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_26904_3_u01
ON cipsrv_epageofab_h.catchment_fabric_26904_3(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_26904_3_u02
ON cipsrv_epageofab_h.catchment_fabric_26904_3(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_26904_3_01i
ON cipsrv_epageofab_h.catchment_fabric_26904_3(catchmentstatecode);

CREATE INDEX IF NOT EXISTS catchment_fabric_26904_3_02i
ON cipsrv_epageofab_h.catchment_fabric_26904_3(nhdplusid);

CREATE INDEX IF NOT EXISTS catchment_fabric_26904_3_spx
ON cipsrv_epageofab_h.catchment_fabric_26904_3 USING gist(shape);

ANALYZE cipsrv_epageofab_h.catchment_fabric_26904_3;

--VACUUM FREEZE ANALYZE cipsrv_epageofab_h.catchment_fabric_26904_3;

...
ALTER TABLE cipsrv_epageofab_h.catchment_fabric_5070_1 OWNER TO cipsrv;
GRANT SELECT ON cipsrv_epageofab_h.catchment_fabric_5070_1 TO public;

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_5070_1_pk
ON cipsrv_epageofab_h.catchment_fabric_5070_1(nhdplusid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_5070_1_u01
ON cipsrv_epageofab_h.catchment_fabric_5070_1(objectid);

CREATE UNIQUE INDEX IF NOT EXISTS catchment_fabric_5070_1_u02
ON cipsrv_epageofab_h.catchment_fabric_5070_1(globalid);

CREATE INDEX IF NOT EXISTS catchment_fabric_5070_1_spx
ON cipsrv_epageofab_h.catchment_fabric_5070_1 USING gist(shape);

ANALYZE cipsrv_epageofab_h.catchment_fabric_5070_1;

--VACUUM FREEZE ANALYZE cipsrv_epageofab_h.catchment_fabric_5070_1;

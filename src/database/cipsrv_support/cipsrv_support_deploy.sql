...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.2.1-81-ga0f5a7b';
   c_gitcommit     CONSTANT VARCHAR(255) := 'a0f5a7b8b92b90cedeb55cf9c6172ab109915348';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Wed May 7 07:22:06 2025 -0400';

...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.2.1-124-g31592d7';
   c_gitcommit     CONSTANT VARCHAR(255) := '31592d7fb6935d6cbc5e2cf3ecfc351dcfdefe28';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Tue Sep 23 17:53:10 2025 -0400';

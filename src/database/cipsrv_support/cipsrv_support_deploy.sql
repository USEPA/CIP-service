...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.5.2-8-g1426054';
   c_gitcommit     CONSTANT VARCHAR(255) := '1426054c44e65b88587a943f59cedf58a0845283';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Thu Jan 15 15:53:53 2026 -0500';

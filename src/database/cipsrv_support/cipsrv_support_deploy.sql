...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.2.1-132-gf83582e';
   c_gitcommit     CONSTANT VARCHAR(255) := 'f83582e07954ca896d1865db2f71e097cb6d606d';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Thu Sep 25 17:04:37 2025 -0400';

...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.2.1-83-g4f3de21';
   c_gitcommit     CONSTANT VARCHAR(255) := '4f3de21f1e1b4eb3c048493d3adf06a781ce8406';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Thu May 8 15:25:49 2025 -0400';

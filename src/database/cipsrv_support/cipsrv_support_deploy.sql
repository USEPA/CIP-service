...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.2.1-169-ge45e376';
   c_gitcommit     CONSTANT VARCHAR(255) := 'e45e3762499cb965f76587a201b5a2c9775fdb68';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Sat Nov 15 16:46:30 2025 -0500';

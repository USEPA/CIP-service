...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.2.1-150-ga74653b';
   c_gitcommit     CONSTANT VARCHAR(255) := 'a74653b8d5a3051c5f0eceeb64da957f05638f6d';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Mon Oct 6 19:18:02 2025 -0400';

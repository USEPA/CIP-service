...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v0.1.2-128-gaf16ce5';
   c_gitcommit     CONSTANT VARCHAR(255) := 'af16ce5273bb567be8d82a18faee892cdf165d66';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Tue Oct 22 18:48:46 2024 -0400';

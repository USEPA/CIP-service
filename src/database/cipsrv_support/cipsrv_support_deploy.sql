...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.2.1-94-g13cc9a6';
   c_gitcommit     CONSTANT VARCHAR(255) := '13cc9a6a69ee4e4a3ac31e7f0cf56d05d46039ca';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Tue May 13 10:40:48 2025 -0400';

...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.5.1-37-g66a8705';
   c_gitcommit     CONSTANT VARCHAR(255) := '66a87052973135f62457e94c07eba7afe8ffe5f5';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Fri Nov 21 07:51:42 2025 -0500';

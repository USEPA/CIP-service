...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.5.1-27-gda0e4be';
   c_gitcommit     CONSTANT VARCHAR(255) := 'da0e4be1fb6daa1346942200284a58cead7974e9';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Tue Nov 18 08:12:53 2025 -0500';

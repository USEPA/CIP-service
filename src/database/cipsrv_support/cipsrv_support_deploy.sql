...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.2.1-170-gc118511';
   c_gitcommit     CONSTANT VARCHAR(255) := 'c1185118105990bc533ae8aa5064a5844b6d0842';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Sat Nov 15 17:24:20 2025 -0500';

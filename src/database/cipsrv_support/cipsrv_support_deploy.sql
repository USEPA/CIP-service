...
AS $BODY$
DECLARE
   c_gitrelease    CONSTANT VARCHAR(255) := 'v1.2.1-14-g22c12b1';
   c_gitcommit     CONSTANT VARCHAR(255) := '22c12b16550cb17c9d6c12f672a1d54e4e32a3ec';
   c_gitcommitdate CONSTANT VARCHAR(255) := 'Wed Feb 19 07:36:22 2025 -0500';

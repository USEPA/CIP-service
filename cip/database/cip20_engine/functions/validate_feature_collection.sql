CREATE OR REPLACE FUNCTION cip20_engine.validate_feature_collection(
    IN  p_in                           JSONB
   ...
   THEN
      ...
      THEN
         ...
         THEN
            ...
            LOOP
               rec := cip20_engine.validate_feature(
...
ALTER FUNCTION cip20_engine.validate_feature_collection(
    JSONB
   ,VARCHAR
   ,VARCHAR
   ,INTEGER
...
GRANT EXECUTE ON FUNCTION cip20_engine.validate_feature_collection(
    JSONB
   ,VARCHAR
   ,VARCHAR
   ,INTEGER

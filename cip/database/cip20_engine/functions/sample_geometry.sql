CREATE OR REPLACE FUNCTION cip20_engine.sample_geometry(
    IN  p_in                         GEOMETRY
) RETURNS GEOMETRY
IMMUTABLE
AS $BODY$ 
...
ALTER FUNCTION cip20_engine.sample_geometry(
   GEOMETRY
) OWNER TO cip20;

GRANT EXECUTE ON FUNCTION cip20_engine.sample_geometry(
   GEOMETRY
) TO PUBLIC;

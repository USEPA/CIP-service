...
DROP MATERIALIZED VIEW IF EXISTS cip20_nhdplus_h.nhdplusflowlinevaa_catnodes CASCADE;

CREATE MATERIALIZED VIEW cip20_nhdplus_h.nhdplusflowlinevaa_catnodes(
    nhdplusid
   ,hydroseq
   ,levelpathi
   ,fromnode
...
WITH cat AS (
    ...
    ,aa.lengthkm
    FROM
    cip20_nhdplus_h.nhdplusflowlinevaa aa
    WHERE 
    EXISTS (SELECT 1 FROM cip20_nhdplus_h.catchment_fabric bb WHERE bb.nhdplusid = aa.nhdplusid)
)
,nocat AS (
   SELECT
    cc.hydroseq
   ...
   ,cc.tonode
   FROM
   cip20_nhdplus_h.nhdplusflowlinevaa cc
   WHERE 
   NOT EXISTS (SELECT 1 FROM cip20_nhdplus_h.catchment_fabric dd WHERE dd.nhdplusid = cc.nhdplusid)
) 
SELECT
 a.nhdplusid
,a.hydroseq
...
ALTER TABLE cip20_nhdplus_h.nhdplusflowlinevaa_catnodes OWNER TO cip20;
GRANT SELECT ON cip20_nhdplus_h.nhdplusflowlinevaa_catnodes TO public;

CREATE UNIQUE INDEX nhdplusflowlinevaa_catnodes_01u
ON cip20_nhdplus_h.nhdplusflowlinevaa_catnodes(nhdplusid);

CREATE UNIQUE INDEX nhdplusflowlinevaa_catnodes_02u
ON cip20_nhdplus_h.nhdplusflowlinevaa_catnodes(hydroseq);

CREATE INDEX nhdplusflowlinevaa_catnodes_01i
ON cip20_nhdplus_h.nhdplusflowlinevaa_catnodes(levelpathi);

CREATE INDEX nhdplusflowlinevaa_catnodes_02i
ON cip20_nhdplus_h.nhdplusflowlinevaa_catnodes(fromnode);

CREATE INDEX nhdplusflowlinevaa_catnodes_03i
ON cip20_nhdplus_h.nhdplusflowlinevaa_catnodes(tonode);

CREATE INDEX nhdplusflowlinevaa_catnodes_04i
ON cip20_nhdplus_h.nhdplusflowlinevaa_catnodes(connector_fromnode);

CREATE INDEX nhdplusflowlinevaa_catnodes_05i
ON cip20_nhdplus_h.nhdplusflowlinevaa_catnodes(connector_tonode);

ANALYZE cip20_nhdplus_h.nhdplusflowlinevaa_catnodes;

--VACUUM FREEZE ANALYZE cip20_nhdplus_h.nhdplusflowlinevaa_catnodes;
--******************************--
----- materialized views/nhdplusflowlinevaa_levelpathi.sql 

DROP MATERIALIZED VIEW IF EXISTS cip20_nhdplus_h.nhdplusflowlinevaa_levelpathi CASCADE;

CREATE MATERIALIZED VIEW cip20_nhdplus_h.nhdplusflowlinevaa_levelpathi(
    levelpathi
   ,max_hydroseq
   ,min_hydroseq
   ,fromnode
...
,a.max_hydroseq
,a.min_hydroseq
,(SELECT c.fromnode FROM cip20_nhdplus_h.nhdplusflowlinevaa c WHERE c.hydroseq = a.max_hydroseq) AS fromnode
,(SELECT d.tonode   FROM cip20_nhdplus_h.nhdplusflowlinevaa d WHERE d.hydroseq = a.min_hydroseq) AS tonode
...
ALTER TABLE cip20_nhdplus_h.nhdplusflowlinevaa_levelpathi OWNER TO cip20;
GRANT SELECT ON cip20_nhdplus_h.nhdplusflowlinevaa_levelpathi TO public;

CREATE UNIQUE INDEX nhdplusflowlinevaa_levelpathi_01u
ON cip20_nhdplus_h.nhdplusflowlinevaa_levelpathi(levelpathi);

CREATE INDEX nhdplusflowlinevaa_levelpathi_01i
ON cip20_nhdplus_h.nhdplusflowlinevaa_levelpathi(max_hydroseq);

CREATE INDEX nhdplusflowlinevaa_levelpathi_02i
ON cip20_nhdplus_h.nhdplusflowlinevaa_levelpathi(min_hydroseq);

CREATE INDEX nhdplusflowlinevaa_levelpathi_03i
ON cip20_nhdplus_h.nhdplusflowlinevaa_levelpathi(fromnode);

CREATE INDEX nhdplusflowlinevaa_levelpathi_04i
ON cip20_nhdplus_h.nhdplusflowlinevaa_levelpathi(tonode);

ANALYZE cip20_nhdplus_h.nhdplusflowlinevaa_levelpathi;

--VACUUM FREEZE ANALYZE cip20_nhdplus_h.nhdplusflowlinevaa_nocat;
--******************************--
...
DROP MATERIALIZED VIEW IF EXISTS cip20_nhdplus_h.catchment_5070 CASCADE;

CREATE MATERIALIZED VIEW cip20_nhdplus_h.catchment_5070(
    nhdplusid
   ,areasqkm
   ---
   ,hydroseq
...
ALTER TABLE cip20_nhdplus_h.catchment_5070 OWNER TO cip20;
GRANT SELECT ON cip20_nhdplus_h.catchment_5070 TO public;

CREATE UNIQUE INDEX catchment_5070_01u
ON cip20_nhdplus_h.catchment_5070(nhdplusid);

CREATE UNIQUE INDEX catchment_5070_02u
ON cip20_nhdplus_h.catchment_5070(hydroseq);

CREATE INDEX catchment_5070_01i
ON cip20_nhdplus_h.catchment_5070(levelpathi);

CREATE INDEX catchment_5070_02i
ON cip20_nhdplus_h.catchment_5070(fcode);

CREATE INDEX catchment_5070_spx
ON cip20_nhdplus_h.catchment_5070 USING GIST(shape);

CREATE INDEX catchment_5070_spx2
ON cip20_nhdplus_h.catchment_5070 USING GIST(shape_centroid);

ANALYZE cip20_nhdplus_h.catchment_5070;

--VACUUM FREEZE ANALYZE cip20_nhdplus_h.catchment_5070;

--******************************--
----- materialized views/catchment_26904.sql 

DROP MATERIALIZED VIEW IF EXISTS cip20_nhdplus_h.catchment_26904 CASCADE;

CREATE MATERIALIZED VIEW cip20_nhdplus_h.catchment_26904(
    nhdplusid
   ,areasqkm
   ---
   ,hydroseq
...
ALTER TABLE cip20_nhdplus_h.catchment_26904 OWNER TO cip20;
GRANT SELECT ON cip20_nhdplus_h.catchment_26904 TO public;

CREATE UNIQUE INDEX catchment_26904_01u
ON cip20_nhdplus_h.catchment_26904(nhdplusid);

CREATE UNIQUE INDEX catchment_26904_02u
ON cip20_nhdplus_h.catchment_26904(hydroseq);

CREATE INDEX catchment_26904_01i
ON cip20_nhdplus_h.catchment_26904(levelpathi);

CREATE INDEX catchment_26904_02i
ON cip20_nhdplus_h.catchment_26904(fcode);

CREATE INDEX catchment_26904_spx
ON cip20_nhdplus_h.catchment_26904 USING GIST(shape);

CREATE INDEX catchment_26904_spx2
ON cip20_nhdplus_h.catchment_26904 USING GIST(shape_centroid);

ANALYZE cip20_nhdplus_h.catchment_26904;

--VACUUM FREEZE ANALYZE cip20_nhdplus_h.catchment_26904;

--******************************--
----- materialized views/catchment_32161.sql 

DROP MATERIALIZED VIEW IF EXISTS cip20_nhdplus_h.catchment_32161 CASCADE;

CREATE MATERIALIZED VIEW cip20_nhdplus_h.catchment_32161(
    nhdplusid
   ,areasqkm
   ---
   ,hydroseq
...
ALTER TABLE cip20_nhdplus_h.catchment_32161 OWNER TO cip20;
GRANT SELECT ON cip20_nhdplus_h.catchment_32161 TO public;

CREATE UNIQUE INDEX catchment_32161_01u
ON cip20_nhdplus_h.catchment_32161(nhdplusid);

CREATE UNIQUE INDEX catchment_32161_02u
ON cip20_nhdplus_h.catchment_32161(hydroseq);

CREATE INDEX catchment_32161_01i
ON cip20_nhdplus_h.catchment_32161(levelpathi);

CREATE INDEX catchment_32161_02i
ON cip20_nhdplus_h.catchment_32161(fcode);

CREATE INDEX catchment_32161_spx
ON cip20_nhdplus_h.catchment_32161 USING GIST(shape);

CREATE INDEX catchment_32161_spx2
ON cip20_nhdplus_h.catchment_32161 USING GIST(shape_centroid);

ANALYZE cip20_nhdplus_h.catchment_32161;

--VACUUM FREEZE ANALYZE cip20_nhdplus_h.catchment_32161;
...
ALTER TABLE cip20_nhdplus_h.catchment_32655 OWNER TO cip20;
GRANT SELECT ON cip20_nhdplus_h.catchment_32655 TO public;

CREATE UNIQUE INDEX catchment_32655_01u
ON cip20_nhdplus_h.catchment_32655(nhdplusid);

CREATE UNIQUE INDEX catchment_32655_02u
ON cip20_nhdplus_h.catchment_32655(hydroseq);

CREATE INDEX catchment_32655_01i
ON cip20_nhdplus_h.catchment_32655(levelpathi);

CREATE INDEX catchment_32655_02i
ON cip20_nhdplus_h.catchment_32655(fcode);

CREATE INDEX catchment_32655_spx
ON cip20_nhdplus_h.catchment_32655 USING GIST(shape);

CREATE INDEX catchment_32655_spx2
ON cip20_nhdplus_h.catchment_32655 USING GIST(shape_centroid);

ANALYZE cip20_nhdplus_h.catchment_32655;

--VACUUM FREEZE ANALYZE cip20_nhdplus_h.catchment_32655;

--******************************--
----- materialized views/catchment_32702.sql 

DROP MATERIALIZED VIEW IF EXISTS cip20_nhdplus_h.catchment_32702 CASCADE;
...
CREATE OR REPLACE FUNCTION cip20_nhdplus_h.generic_common_mbr(
   IN  p_input  VARCHAR
) RETURNS GEOMETRY 
IMMUTABLE
AS
...
ALTER FUNCTION cip20_nhdplus_h.generic_common_mbr(
   VARCHAR
) OWNER TO cip20;

GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.generic_common_mbr(
   VARCHAR
) TO PUBLIC;
...
CREATE OR REPLACE FUNCTION cip20_nhdplus_h.query_generic_common_mbr(
   IN  p_input  GEOMETRY
) RETURNS VARCHAR
IMMUTABLE
AS
...
BEGIN
   ...
   IF ST_Intersects(
       sdo_point
      ,cip20_nhdplus_h.generic_common_mbr('CONUS')
   )
   THEN
      RETURN 'CONUS';
   ...
   ELSIF ST_Intersects(
       sdo_point
      ,cip20_nhdplus_h.generic_common_mbr('HI')
   )
   THEN
      RETURN 'HI';
   ...
   ELSIF ST_Intersects(
       sdo_point
      ,cip20_nhdplus_h.generic_common_mbr('PRVI')
   )
   THEN
      RETURN 'PRVI';
   ...
   ELSIF ST_Intersects(
       sdo_point
      ,cip20_nhdplus_h.generic_common_mbr('AK')
   )
   THEN
      RETURN 'AK';
   ...
   ELSIF ST_Intersects(
       sdo_point
      ,cip20_nhdplus_h.generic_common_mbr('GUMP')
   )
   THEN
      RETURN 'GUMP';
   ...
   ELSIF ST_Intersects(
       sdo_point
      ,cip20_nhdplus_h.generic_common_mbr('SAMOA')
   )
   THEN
      RETURN 'SAMOA';
...
ALTER FUNCTION cip20_nhdplus_h.query_generic_common_mbr(
   GEOMETRY
) OWNER TO cip20;

GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.query_generic_common_mbr(
   GEOMETRY
) TO PUBLIC;
...
CREATE OR REPLACE FUNCTION cip20_nhdplus_h.determine_grid_srid(
...
BEGIN
   ...
   THEN
      str_region := cip20_nhdplus_h.query_generic_common_mbr(
         p_input := p_geometry
      );
...
ALTER FUNCTION cip20_nhdplus_h.determine_grid_srid(
    GEOMETRY
   ,VARCHAR
) OWNER TO cip20;

GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.determine_grid_srid(
    GEOMETRY
   ,VARCHAR
) TO PUBLIC;
...
CREATE or REPLACE FUNCTION cip20_nhdplus_h.temp_table_exists(
...
ALTER FUNCTION cip20_nhdplus_h.temp_table_exists(
   VARCHAR
) OWNER TO cip20;

GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.temp_table_exists(
   VARCHAR
) TO PUBLIC;
...
CREATE OR REPLACE FUNCTION cip20_nhdplus_h.index_point(
    IN  p_geometry             GEOMETRY
   ,IN  p_known_region         VARCHAR
   ,OUT p_return_code          INTEGER
   ,OUT p_status_message       VARCHAR
...
BEGIN
   ...
   THEN
      ...
      a.nhdplusid
      FROM
      cip20_nhdplus_h.catchment_5070 a
      WHERE
      ST_Intersects(
          a.shape
         ,geom_input
   ...
   THEN
      ...
      a.nhdplusid
      FROM
      cip20_nhdplus_h.catchment_3338 a
      WHERE
      ST_Intersects(
          a.shape
         ,geom_input
   ...
   THEN
      ...
      a.nhdplusid
      FROM
      cip20_nhdplus_h.catchment_26904 a
      WHERE
      ST_Intersects(
          a.shape
         ,geom_input
   ...
   THEN
      ...
      a.nhdplusid
      FROM
      cip20_nhdplus_h.catchment_32161 a
      WHERE
      ST_Intersects(
          a.shape
         ,geom_input
   ...
   THEN
      ...
      a.nhdplusid
      FROM
      cip20_nhdplus_h.catchment_32655 a
      WHERE
      ST_Intersects(
          a.shape
         ,geom_input
   ...
   THEN
      ...
      a.nhdplusid
      FROM
      cip20_nhdplus_h.catchment_32702 a
      WHERE
      ST_Intersects(
          a.shape
         ,geom_input
...
ALTER FUNCTION cip20_nhdplus_h.index_point(
    GEOMETRY
   ,VARCHAR
) OWNER TO cip20;

GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.index_point(
    GEOMETRY
   ,VARCHAR
) TO PUBLIC;
...
CREATE OR REPLACE FUNCTION cip20_nhdplus_h.index_area_simple(
    IN  p_geometry             GEOMETRY
...
ALTER FUNCTION cip20_nhdplus_h.index_area_simple(
    GEOMETRY
   ,NUMERIC
   ,VARCHAR
   ,NUMERIC
...
GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.index_area_simple(
    GEOMETRY
   ,NUMERIC
   ,VARCHAR
   ,NUMERIC
...
CREATE OR REPLACE FUNCTION cip20_nhdplus_h.index_area_centroid(
    IN  p_geometry             GEOMETRY
   ,IN  p_geometry_areasqkm    NUMERIC
   ,IN  p_known_region         VARCHAR
   ,IN  p_cat_threashold_perc  NUMERIC
...
ALTER FUNCTION cip20_nhdplus_h.index_area_centroid(
    GEOMETRY
   ,NUMERIC
   ,VARCHAR
   ,NUMERIC
...
GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.index_area_centroid(
    GEOMETRY
   ,NUMERIC
   ,VARCHAR
   ,NUMERIC
...
CREATE OR REPLACE FUNCTION cip20_nhdplus_h.index_area_artpath(
    IN  p_geometry             GEOMETRY
   ,IN  p_geometry_areasqkm    NUMERIC
   ,IN  p_known_region         VARCHAR
   ,IN  p_cat_threashold_perc  NUMERIC
...
ALTER FUNCTION cip20_nhdplus_h.index_area_artpath(
    GEOMETRY
   ,NUMERIC
   ,VARCHAR
   ,NUMERIC
...
GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.index_area_artpath(
    GEOMETRY
   ,NUMERIC
   ,VARCHAR
   ,NUMERIC

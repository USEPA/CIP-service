CREATE OR REPLACE FUNCTION cip20_nhdplus_h.index_line_levelpath(
...
BEGIN
   ...
   LOOP
      out_return_code := cip20_nhdplus_h.create_line_temp_tables();
...
ALTER FUNCTION cip20_nhdplus_h.index_line_levelpath(
    GEOMETRY
   ,NUMERIC
   ,VARCHAR
   ,NUMERIC
...
GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.index_line_levelpath(
    GEOMETRY
   ,NUMERIC
   ,VARCHAR
   ,NUMERIC

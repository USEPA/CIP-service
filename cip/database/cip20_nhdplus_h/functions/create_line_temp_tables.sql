CREATE OR REPLACE FUNCTION cip20_nhdplus_h.create_line_temp_tables()
RETURNS INT4
VOLATILE
AS $BODY$
DECLARE
BEGIN
   ...
   ----------------------------------------------------------------------------
   IF cip20_nhdplus_h.temp_table_exists('tmp_line')
   THEN
   ...
   ----------------------------------------------------------------------------
   IF cip20_nhdplus_h.temp_table_exists('tmp_line_levelpathi')
   THEN
...
ALTER FUNCTION cip20_nhdplus_h.create_line_temp_tables() OWNER TO cip20;

GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.create_line_temp_tables() TO PUBLIC;

CREATE OR REPLACE FUNCTION cip20_nhdplus_h.index_point_simple(
...
ALTER FUNCTION cip20_nhdplus_h.index_point_simple(
    GEOMETRY
   ,VARCHAR
) OWNER TO cip20;

GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.index_point_simple(
    GEOMETRY
   ,VARCHAR
) TO PUBLIC;

CREATE OR REPLACE FUNCTION cip20_nhdplus_h.index_line_simple(
...
ALTER FUNCTION cip20_nhdplus_h.index_line_simple(
    GEOMETRY
   ,NUMERIC
   ,VARCHAR
   ,NUMERIC
...
GRANT EXECUTE ON FUNCTION cip20_nhdplus_h.index_line_simple(
    GEOMETRY
   ,NUMERIC
   ,VARCHAR
   ,NUMERIC

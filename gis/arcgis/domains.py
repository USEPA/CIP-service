...
def HWType(target_ws,table_name,field_name,domname=None):
   ...
   try:
      arcpy.CreateDomain_management(target_ws,domname," ","SHORT","CODED");
...
###############################################################################
def FlowDir(target_ws,table_name,field_name,domname=None):
...
###############################################################################      
def ParameterName(target_ws,table_name,field_name,domname=None):
   
   if domname is None:
      domname = "ParameterName";
...
###############################################################################      
def Process(target_ws,table_name,field_name,domname=None):
...
###############################################################################      
def ChangeCode(target_ws,table_name,field_name,domname=None):
...
###############################################################################      
def ReachFileVersion(target_ws,table_name,field_name,domname=None):
   
   if domname is None:
      domname = "ReachFileVersion";
...
###############################################################################      
def PurpCode(target_ws,table_name,field_name,domname=None):
...
###############################################################################      
def StatusFlag(target_ws,table_name,field_name,domname=None):
...
###############################################################################      
def HuType(target_ws,table_name,field_name,domname=None):

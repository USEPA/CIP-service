...
def main():
   ...
   source_path = os.path.dirname(os.path.realpath(__file__)) + os.sep + "owld_wqp";
   ...
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_attr");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_cip");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_cip_geo");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_control");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_huc12");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_huc12_geo");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_rad_a");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_rad_evt2meta");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_rad_l");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_rad_metadata");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_rad_p");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_rad_srccit");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_sfid");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_src_a");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_src_l");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_src_p");
   egdb_return = egdb_conn.execute("TRUNCATE TABLE owld_public.wqp_src2cip");

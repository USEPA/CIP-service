...
work_path = os.path.dirname(os.path.realpath(__file__)) + os.sep + "hydrologicunits_nphr";
container_name = "hydrologicunits_nphr.gdb";
...
###############################################################################
source    = source_conn + r"/cipsrv_gis.wbd_hu12sp_nphr_esri";
outname   = "hu12sp";
target_nm = work_path + os.sep + container_name + os.sep + outname;
ret       = fcexporter(source,outname,work_path,container_name,force_date=force_date);
...
###############################################################################
source    = source_conn + r"/cipsrv_gis.wbd_hu10_nphr_esri";
outname   = "hu10";
target_nm = work_path + os.sep + container_name + os.sep + outname;
ret       = fcexporter(source,outname,work_path,container_name,force_date=force_date);
...
###############################################################################
source    = source_conn + r"/cipsrv_gis.wbd_hu10sp_nphr_esri";
outname   = "hu10sp";
target_nm = work_path + os.sep + container_name + os.sep + outname;
ret       = fcexporter(source,outname,work_path,container_name,force_date=force_date);
...
###############################################################################
source    = source_conn + r"/cipsrv_gis.wbd_hu8_nphr_esri";
outname   = "hu8";
target_nm = work_path + os.sep + container_name + os.sep + outname;
ret       = fcexporter(source,outname,work_path,container_name,force_date=force_date);
...
###############################################################################
source    = source_conn + r"/cipsrv_gis.wbd_hu8sp_nphr_esri";
outname   = "hu8sp";
target_nm = work_path + os.sep + container_name + os.sep + outname;
ret       = fcexporter(source,outname,work_path,container_name,force_date=force_date);
...
###############################################################################
source    = source_conn + r"/cipsrv_gis.wbd_hu6_nphr_esri";
outname   = "hu6";
target_nm = work_path + os.sep + container_name + os.sep + outname;
ret       = fcexporter(source,outname,work_path,container_name,force_date=force_date);
...
###############################################################################
source    = source_conn + r"/cipsrv_gis.wbd_hu6sp_nphr_esri";
outname   = "hu6sp";
target_nm = work_path + os.sep + container_name + os.sep + outname;
ret       = fcexporter(source,outname,work_path,container_name,force_date=force_date);
...
###############################################################################
source    = source_conn + r"/cipsrv_gis.wbd_hu4_nphr_esri";
outname   = "hu4";
target_nm = work_path + os.sep + container_name + os.sep + outname;
ret       = fcexporter(source,outname,work_path,container_name,force_date=force_date);
...
###############################################################################
source    = source_conn + r"/cipsrv_gis.wbd_hu4sp_nphr_esri";
outname   = "hu4sp";
target_nm = work_path + os.sep + container_name + os.sep + outname;
ret       = fcexporter(source,outname,work_path,container_name,force_date=force_date);
...
###############################################################################
source    = source_conn + r"/cipsrv_gis.wbd_hu2_nphr_esri";
outname   = "hu2";
target_nm = work_path + os.sep + container_name + os.sep + outname;
ret       = fcexporter(source,outname,work_path,container_name,force_date=force_date);
...
###############################################################################
source    = source_conn + r"/cipsrv_gis.wbd_hu2sp_nphr_esri";
outname   = "hu2sp";
target_nm = work_path + os.sep + container_name + os.sep + outname;
ret       = fcexporter(source,outname,work_path,container_name,force_date=force_date);
